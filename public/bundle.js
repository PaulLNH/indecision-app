...
var _AddOption = __webpack_require__(96);
...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        value: function handleDeleteOption(optionToRemove) {
            ...
            // localStorage.removeItem(JSON.stringify(optionToRemove));
        }
    }, {
        key: 'handlePick',
...
var _IndecisionApp = __webpack_require__(101);
...
*/
var aa=__webpack_require__(6),n=__webpack_require__(3),ba=__webpack_require__(12);function ca(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var k=[c,d,e,f,g,h],l=0;a=Error(b.replace(/%s/g,function(){return k[l++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var AddListOption = function (_React$Component) {
    _inherits(AddListOption, _React$Component);

    function AddListOption(props) {
        _classCallCheck(this, AddListOption);

        var _this = _possibleConstructorReturn(this, (AddListOption.__proto__ || Object.getPrototypeOf(AddListOption)).call(this, props));
    ...
    _createClass(AddListOption, [{
        key: "handleAddOption",
        value: function handleAddOption(formEvent) {
            formEvent.preventDefault();

            var option = formEvent.target.elements.option.value.trim();
